...
// corresponding changes to the buildmeister script
    ...
    #define NV_BUILD_BRANCH             r596_25
#endif
#ifndef NV_PUBLIC_BRANCH
    #define NV_PUBLIC_BRANCH             r596_25
#endif

#if defined(NV_LINUX) || defined(NV_BSD) || defined(NV_SUNOS)
#define NV_BUILD_BRANCH_VERSION         "rel/gpu_drv/r595/r596_25-250"
#define NV_BUILD_CHANGELIST_NUM         (37855471)
#define NV_BUILD_TYPE                   "Official"
#define NV_BUILD_NAME                   "rel/gpu_drv/r595/r596_25-250"
#define NV_LAST_OFFICIAL_CHANGELIST_NUM (37855471)

#else     /* Windows builds */
#define NV_BUILD_BRANCH_VERSION         "r596_25-5"
#define NV_BUILD_CHANGELIST_NUM         (37847067)
#define NV_BUILD_TYPE                   "Official"
#define NV_BUILD_NAME                   "596.36"
#define NV_LAST_OFFICIAL_CHANGELIST_NUM (37847067)
